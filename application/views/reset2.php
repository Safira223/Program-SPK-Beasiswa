                ...
                <div class="card p-4 shadow mb-3">
                    <div class="card-body">
                        <form action="<?php echo site_url('login/resetpassword')?>" method="post">
                            <div class="image">
                                <div align="center">
                                    <img src="<?php echo base_url('assets/images/password.png')?>"  width= "150px" id="logo">
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="password" class="form-control <?php echo form_error('password') ? 'is-invalid':'' ?>" placeholder="password" required>
