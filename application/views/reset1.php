        ...
        <div class="wrap">
            <div class="col-md-4">
                ...
                <div class="card p-4 shadow mb-3">
                    <div class="card-body">
                        <form action="<?php echo site_url('login/pertanyaan')?>" method="post">
                            <div class="image">
                                <div align="center">
                                    <img src="<?php echo base_url('assets/images/question.png')?>"  width= "150px" id="logo">
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="pertanyaan" class="form-control <?php echo form_error('pertanyaan') ? 'is-invalid':'' ?>" placeholder="pertanyaan" required value="<?php echo $res->pertanyaan?>" disabled>
                                        <input type="text" name="jawaban" class="form-control <?php echo form_error('jawaban') ? 'is-invalid':'' ?>" placeholder="Masukkan jawaban anda" required>
